...
/home/ubuntu/.docker/cli-plugins/docker-compose down -v
rm -rf ./master/data/*
rm -rf ./slave/data/*
/home/ubuntu/.docker/cli-plugins/docker-compose build
/home/ubuntu/.docker/cli-plugins/docker-compose up -d
...
until /home/ubuntu/.docker/cli-plugins/docker-compose exec slave sh -c 'export MYSQL_PWD='"$SLAVE_PWD"'; mysql -u root -e ";"'
do
